...
historia = {
   ...
   "cena_a1_foto": {
        "texto": "O celular vibra novamente. O texto em vermelho exige sua atenção:\n\n**OLHE PARA O MENINO DORMINDO NO FUNDO DO VAGÃO. O NOME DELE É MIGUEL. ELE NÃO PODE CHEGAR AO TERMINAL.**\n\nVocê olha para a criança. *Miguel*. Você digita rapidamente: *Por quê?*\n\n**PORQUE FOI ASSIM QUE TUDO COMEÇOU.**\n\nAntes que você possa perguntar o que isso significa, uma sombra cai sobre você. O homem de sobretudo escuro está em pé ao seu lado. Você esconde o aparelho no bolso.\n\n— Com quem você está falando? — o homem pergunta. Você não responde. Ele dá um sorriso triste e murmura para si mesmo: — *Então o ciclo começou mais cedo desta vez...*\n\nEle se afasta. Imediatamente, o celular vibra nas suas mãos suadas:\n**NÃO ESCUTE O HOMEM DE SOBRETUDO. O NOME DELE É DANIEL. ELE É A RAZÃO DE NÓS ESTARMOS PRESOS AQUI.**\n\nDe repente, o alto-falante do trem chia: *'Próxima estação... São Gabriel.'*\nO cronômetro na sua tela dá um salto bizarro, caindo direto para **01:28... 01:27...**\n\nVocê liga os pontos e digita com os dedos trêmulos: *O que acontece em São Gabriel?*\n\nA resposta vem na mesma hora:\n**VOCÊ VAI ME VER DE NOVO. DENTRO DO TREM. QUANDO AS LUZES APAGAREM, NÃO DEIXE NINGUÉM TOCAR EM VOCÊ. ELE AINDA NÃO TEM UM ROSTO COMPLETO.**\n\nVocê digita: *Ele quem?*\n\nA resposta não é um texto. É uma fotografia. Uma foto tirada dentro do próprio vagão, neste exato segundo. Nela, você aparece de costas, olhando para o celular. E bem atrás de você, inclinada sobre o seu ombro, há uma figura muito alta. Sem rosto.",
